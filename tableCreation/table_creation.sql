...
CREATE TABLE IF NOT EXISTS company_local_sells (
  ...
  ruc            NUMERIC(11, 0) NOT NULL,
                 CONSTRAINT fk_company_local_sell_ruc FOREIGN KEY (ruc) REFERENCES provider_companies(ruc),
...
CREATE TABLE IF NOT EXISTS company_delivery_sells (
  ...
  ruc            NUMERIC(11, 0) NOT NULL,
                 CONSTRAINT fk_company_delivery_sell_ruc FOREIGN KEY (ruc) REFERENCES provider_companies(ruc),
  invoice_number NUMERIC(11, 0) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS provisions (
  ...
  ruc         NUMERIC(11, 0) NOT NULL,
              CONSTRAINT fk_provisions_ruc FOREIGN KEY (ruc) REFERENCES provider_companies(ruc),
  date_time   TIMESTAMP      NOT NULL,
...
CREATE TABLE IF NOT EXISTS local_employees(
  ...
  shop_address VARCHAR(50) NOT NULL,
               CONSTRAINT fk_local_employee_shop_address FOREIGN KEY(shop_address) REFERENCES locals(address)
...
CREATE TABLE IF NOT EXISTS shifts(
  ...
  worker_dni     VARCHAR(50) NOT NULL,
                 CONSTRAINT fk_shift_worker_dni FOREIGN KEY(worker_dni) REFERENCES employees(dni),
...
CREATE TABLE IF NOT EXISTS in_charge(
  ...
  shop_address VARCHAR(50) NOT NULL,
               CONSTRAINT fk_in_charge_shop_address FOREIGN KEY(shop_address) REFERENCES locals(address),
...
CREATE TABLE IF NOT EXISTS vehicles(
  ...
  shop_address   VARCHAR(50)   NOT NULL,
                 CONSTRAINT fk_vehicle_shop_address FOREIGN KEY(shop_address) REFERENCES locals(address),
